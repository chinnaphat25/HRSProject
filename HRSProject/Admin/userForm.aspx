<%@ Page Title="ข้อมูลผู้ใช้" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="userForm.aspx.cs" Inherits="HRSProject.Admin.userForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            สิทธ์การใช้งาน
            <asp:DropDownList ID="txtPrivilege" runat="server" CssClass="form-control"></asp:DropDownList>
        </div>
        <div class="col-md-1">
            <br />
                ...
                <asp:GridView ID="UserGridView" runat="server"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Username">
                            <ItemTemplate>
                                <asp:Label ID="lbUser" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.emp_user_name") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ชื่อ-สกุล">
                            <ItemTemplate>
                                <asp:Label ID="lbName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.emp_name") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtEName" size="20" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.emp_name") %>' CssClass="form-control"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="สิทธ์การใช้งาน">
                            <ItemTemplate>
                                <asp:Label ID="lbPrivilege" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.privilege_name") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
